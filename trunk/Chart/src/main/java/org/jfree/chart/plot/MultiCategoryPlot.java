 ...
 *
 * $Id: CombinedDomainCategoryPlot.java,v 1.9.2.3 2006/10/30 13:11:11 mungady Exp $
 *
 * Changes:
 * --------
...
public class MultiCategoryPlot extends CategoryPlot
                                        implements Zoomable,
     ...
     *                    permitted).
     */
    public MultiCategoryPlot(CategoryAxis domainAxis) {
    ...
    protected AxisSpace calculateAxisSpace(Graphics2D g2, 
        ...
        */
        ...
        if (orientation == PlotOrientation.HORIZONTAL) {
            usableSize = plotArea.getWidth() - this.gap * (n - 1);
        }
        else if (orientation == PlotOrientation.VERTICAL) {
            usableSize = plotArea.getHeight() - this.gap * (n - 1);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MultiCategoryPlot)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        MultiCategoryPlot plot = (MultiCategoryPlot) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        MultiCategoryPlot result 
            = (MultiCategoryPlot) super.clone(); 
